...
This file is the ONLY file the agent modifies. Test data, accuracy
verification, and hardware detection live in prepare.py (immutable).
...
from prepare import (
    # Constants
    MODEL_NAME, MODEL_PARAMS_B, MODEL_SIZE_GB,
    PREFILL_SEQ_LENS, PREFILL_TTFT_TARGETS,
    DECODE_LATENCY_CONSTRAINTS, DECODE_CONTEXT_DEPTHS, DECODE_TOKENS,
    ACCURACY_MAX_TOKENS, ACCURACY_PROMPTS, RESULTS_FILE, REFERENCE_FILE,
    # Data classes
    PrefillResult, DecodeResult, AccuracyResult, AccuracySuiteResult, BenchmarkResults,
    # Functions
    get_memory_mb, get_chip_info, generate_synthetic_prompt,
    verify_semantic_answer, load_reference_outputs, save_reference_outputs,
)


# =============================================================================
# Optimization Flags - AGENT MODIFIES THESE
# =============================================================================
